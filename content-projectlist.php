...
?>
	<div class='well'>
		...
		<div class='col-xs-12 h3 red'><a href='/tasklist/?ID=<?php echo $lead->ID; ?>' class='h3'><?php echo $lead->post_title; ?></a></div>
				<div class='clear'></div><hr>
		<div class='col-sm-3'>
		<?php
		...
		<?php
			...
			<div class='clear'></div>
					<div class='col-xs-12 h4 red hidden'>Kelly Blue Book: $2,895</div><br>
		...
		<div class='col-sm-3'>
			...
			<h4>Tasks</h4>
			<h1 class='red'><?php echo get_field( 'total_tasks', $lead->ID, 1 ); ?><small class='red'></small></h1>
			<br>Max Budget: $<?php echo get_field( 'total_budget', $lead->ID, 1 ); ?><br><hr>
...
<div class=' report text-center1 hidden1'>
		...
		<div class=' col-xs-8 col-sm-4'>
			...
			<div class='col-xs-2 text-center hidden-print hidden-xs'>
				<u>Max Budget</u><br>
				<?php 
			...
			<div class='col-xs-4  col-sm-2  text-center'>
				<u>Lowest Bid</u><br>
				<?php 
					if(get_field( 'lowest_bid', $task->ID , 1 )){
						?>
						$<?php echo  get_field( 'lowest_bid', $task->ID , 1 ); ?>
						<?php
					}else{
						echo "- No Bids -";
					}
			...
			<div class='col-xs-12 col-sm-2 text-center hidden-print'>
...
<div id='details<?php echo $task->ID; ?>' class='' style='display: none;' >			
		<form method="post" action="" class=''>
			<button name="task_complete" type="submit" class='btn btn-success btn-block btn-lg hidden' value="Remove Lead" />Completed!</button>
