...
<?php //get_template_part('content','new-contact'); ?>
	...
	// The Query
				...
				$leads = get_posts( array( 'post_type' => 'ssi_classmates' , 'posts_per_page' => -1 ) );
...
<?php if(!$_GET['filter']){ ?>
<hr>
<h4><u><?php echo count($leads); ?></u> Classmates</h4>
...
if( !$_GET['filter'] ){ 
		...
		$args = array( 'post_type' => 'ssi_classmates'  , 'posts_per_page' => $num_posts, 'orderby'=> 'modified', 'order' => $order  );
		...
		<hr>
		<center>
		<h4><u><?php echo count($connections); ?></u> Classmates</h4><br>
		</center>
		<hr>
