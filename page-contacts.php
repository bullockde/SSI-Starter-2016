...
<div class='clearfix'></div>
	...
	// The Query
				...
				$args = array( 'post_type' => 'ssi_contacts'  , 'posts_per_page' => $num_posts, 'orderby'=> 'modified', 'order' => $order  );
				
				$args4 = array( 'post_type' => 'ssi_tenants'  , 'posts_per_page' => $num_posts, 'orderby'=> 'modified', 'order' => $order  );
...
<div id='details<?php echo $lead->ID; ?>' class='details' style='display: none;'>
		...
		<form id="update" method='post'>	
				...
				<div class='col-sm-12'> 
					...
					<div class='col-sm-2'>
						 <input type="text" name="MX_user_zip_code" placeholder="Zip Code" value="<?php echo get_field( 'zip_code', $lead->ID ); ?>">
					</div>
					<div class='col-sm-2'>
