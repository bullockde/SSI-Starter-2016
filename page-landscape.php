...
<div class='clearfix'></div>
	...
	// The Query
				...
				$args = array( 'post_type' => array( 'ssi_contacts', 'ssi_clients', 'ssi_connections' ) , 'category_name' => 'landscape'  , 'posts_per_page' => $num_posts, 'orderby'=> 'modified' );
...
<?php echo get_stylesheet_directory_uri(); ?>/images/icons/icon-<?php echo $site->post_name; ?>.png'  class=''>
	...
	?>				<div class='clearfix'></div>
				...
				<div class='col-xs-2 col-sm-2 hidden'>	
				
					<div class='clearfix'></div>
					<button id='details<?php echo $lead->ID; ?>' class='btn  btn-block btn-default hidden '>Details</button>
					<div class='clearfix'></div>
				</div>
					
					<div class='col-xs-2 col-sm-2 hidden'>	
					<a href='/admin/report/?ID=<?php echo $lead->ID; ?>' target='_blank' class='btn  btn-block btn-default hidden '>Report ></a>
					<div class='clearfix'></div>
				</div>
...
<div id='details<?php echo $lead->ID; ?>' class='details' style='display: none;'>
	...
	<div class=' col-xs-12'>			
				...
				<div class='col-sm-12' >
					...
					<input width="100" type="text" name="dob" placeholder="D.O.B" value="<?php echo get_field( 'lead_dob', $lead->ID ); ?>">
				</div>
