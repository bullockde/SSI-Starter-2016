	...
	<form method="post" action="">		
		<div class='clear'></div>
				...
				<div class='col-sm-4' >
					...
					<input type="text" name="post_title" placeholder="Name" value="<?php echo $lead->post_title; ?>">
				</div>
				<div class='col-sm-3' >
					<b>Phone: </b> 
...
<div class='clear'></div>
	...
	<div id='details' class='details' style='display: block;'>	
				...
				<b>D.O.B: </b> <input width="100" type="text" name="dob" placeholder="D.O.B" placeholder="<?php echo get_field( 'lead_dob', $lead->ID ); ?>">
...
<div class='clear'></div>
	...
	// The Query
				$num_posts = 30;
				if( $_GET['all'] ){ $num_posts = 300; }
				$order = 'desc';
				
				if( $_GET['order'] ){ $order = $_GET['order']; }
				
				$args = array( 'post_type' => 'ssi_contacts'  , 'posts_per_page' => $num_posts, 'meta_key' => 'lead_dob',
							'orderby'  => 'meta_value_num', 'order' => $order  );
