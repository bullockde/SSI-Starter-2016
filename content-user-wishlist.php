<?php
	...
	$tasks = get_posts( array( 'author' => $_GET["ID"] , 'post_type' => 'ssi_wishlists', 'post_status' => 'publish' , 'posts_per_page' => -1, 'order' => 'DESC' ) );
?>
...
//	}//end foreach
	...
	<div id='Completed-wish' class='tasks' style='display: none;'>
COMPLETED::
<?php
	...
	$tasks = get_posts( array( 'author' => $_GET["ID"] , 'post_type' => 'ssi_wishlists', 'post_status' => 'draft' , 'posts_per_page' => -1, 'order' => 'DESC' ) );
	...
	?>
	<button id='Completed-wish' class='btn btn-default btn-block hidden-print'> Show Completed >> </button>
