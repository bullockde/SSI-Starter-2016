...
<div class='zone'>
	<div class='col-md-8 ad content text-center'>
		...
		<a href='/playlist'><img src='/wp-content/uploads/2015/09/SSIPlaylist-e1445057287376-672x231.png' class='img-responsive'></a>
...
<!----  Video Output from URL  -->
		...
		$all_songs = get_posts( array(  'post_type' => 'music' , 'posts_per_page' => -1) );
...
<div class='playlist'>
	...
	<?php
		...
		echo '<center><input type="submit" value=">>Create My Playlist!<<" class="submit"></center>';
		echo '</form>';	
