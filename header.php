...
?>
	...
	if( get_field( "display_tageline", $post->ID ) != "No" ){  
	
	
	?>
	<section class='tag-line '>
			<center><a href='/'> <img src='/wp-content/uploads/ShamanShawn-nolink-transparent.png' class='header img-responsive hidden'>
	...
	if( /* get_field( "display_header", $post->ID ) == "Yes" */ 0 ){  
