...
<br>
	...
	<?php } ?>			
		...
		<h4>Tasklist</h4> 
			...
			<?php 
	if( get_field( 'ssi_tasklist_ID', $_GET['ID'] ) ){
...
<div class='clearfix'></div>
	...
	?>
		...
		<div id='payments' class=' row payment report col-md-12' style='display: none;'>
			<h4>Payment Info</h4> 
			<div class=''>
				<?php 
				...
				<div id='trans<?php echo get_sub_field('trans_id'); ?>' class='well' style='display: none;'>
					...
					<a target='_blank' href='/wp-admin/post.php?post=<?php the_sub_field('trans_id'); ?>&action=edit'>
					<?php the_sub_field('trans_id'); ?>
					</a>
					</div>
					<div class='clearfix'></div>
					...
					<b>Photo: </b>
						<a target='_blank' href='<?php echo get_the_post_thumbnail_url(get_sub_field('trans_id')); ?>'><img src='<?php echo get_the_post_thumbnail_url(get_sub_field('trans_id')); ?>' width='150px' height='150px'></a>
...
<div id='details<?php echo $lead->ID; ?>' style='display: block;'>
	...
	<div id='add_payment' class='' style='display: none;'>
		...
		<div id='rental' class=' rental col-md-12' style='display: none;'>
			<h4>Rental Info</h4>
			<div class='col-xs-5 col-md-5 well'>
...
<div class='clearfix'></div>
		...
		<div id='notes' class='row summary' style='display: none;'>
			...
			<div class='col-md-6 '>
				...
				echo "<div class='col-xs-12' > " . $content . "</div><br>";		
				?>
			</div>
...
<?php echo get_stylesheet_directory_uri(); ?>/images/icons/icon-<?php echo $site->post_name; ?>.png'  class=''><?php echo get_field( "MX_user_" . $site->post_name , $lead->ID ); ?>
	...
	?>			
			...
			<div class='col-xs-12' >
					...
					<b>Notes: </b> 
					<?php If( !isset($lead->post_content) ){ echo "- No Notes -"; }else{  echo $content; } ?>
