...
?>
		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info">
				&copy;2015 - <?php echo date("Y") ?> Shaman Shawn Inc. | Powered by <a style='text-decoration: underline;' href='http://www.youtube.com/watch?v=9W8tyczXGwI&feature=youtu.be'>Jesus</a>. | <a href='/admin'>Admin Login</a>
			</div><!-- .site-info -->
		</footer><!-- .site-footer -->
	</div><!-- .site-inner -->
